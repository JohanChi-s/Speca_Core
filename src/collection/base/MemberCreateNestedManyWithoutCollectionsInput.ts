...
@InputType()
class MemberCreateNestedManyWithoutCollectionsInput {
...
export { MemberCreateNestedManyWithoutCollectionsInput as MemberCreateNestedManyWithoutCollectionsInput };
