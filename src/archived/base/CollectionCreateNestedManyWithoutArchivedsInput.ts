...
@InputType()
class CollectionCreateNestedManyWithoutArchivedsInput {
...
export { CollectionCreateNestedManyWithoutArchivedsInput as CollectionCreateNestedManyWithoutArchivedsInput };
