...
@InputType()
class DocumentCreateNestedManyWithoutDocumentsInput {
...
export { DocumentCreateNestedManyWithoutDocumentsInput as DocumentCreateNestedManyWithoutDocumentsInput };
